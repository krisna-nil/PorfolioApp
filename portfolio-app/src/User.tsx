...
const socialLinks = [
    { link: "https://github.com/krisna-nil", icon: IconBrandGithub },
    { link: "https://www.linkedin.com/in/nileshdeveloper/", icon: IconBrandLinkedin },
    { link: "https://www.instagram.com/am.nilesh", icon: IconBrandInstagram }, 
    { link: "https://www.youtube.com/@nileshkumar9679", icon: IconBrandYoutube },
    { link: "https://leetcode.com/u/nileshkr123/", icon: IconBrandLeetcode }
];
